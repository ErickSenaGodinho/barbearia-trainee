                ...
                <div className="my-5">
                    <form className="flex flex-col items-center text-left justify-center gap-5" onSubmit={submitRequest}>
                        ...
                        <div className="flex gap-5">
                            <Button color="danger" variant="shadow" className="w-full">Apagar Conta</Button>
                            <Button type="submit" color="primary" variant="shadow" className="w-full text-base" onPress={validateForm}>salvar</Button>
                        </div>
                    </form>
                </div>
            </div>
